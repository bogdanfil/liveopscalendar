...
Columns are matched by their headers: Month, Event, Feature, Development Team, Track, Prod Dates, Dev Dates, and comment. Features sharing a Track share one Schedule row; production occupies the upper lanes and development is always placed below it. Overlapping bars of the same phase use additional lanes within that row. Features with no Track get their own row.
