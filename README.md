...
Run `node preview.cjs` and open `http://127.0.0.1:4174/`. Run `node tests/date-range.test.cjs` and `node tests/calendar.test.cjs` to check parsing, column mapping, grouping, overlays, estimates, presets, and conflict detection.
